package com.store.back.controller.undercarriage;
...
@Controller
@RequestMapping("/back/undercarriage")
public class PageUndercarriageController {
	@Autowired
	private GoodsService goodsService;
	@Autowired
	SortService sortService;
	
	@RequiresPermissions("back:undercarriage:list")
	@RequestMapping("/list")
	public String list() {
		return "goods/undercarriage/list";
	}

	@RequiresPermissions("back:undercarriage:edit")
	@RequestMapping("/edit")
	public String edit(Model model,String storeGoodsId) {
		...
		return "goods/undercarriage/edit";
	}
}
