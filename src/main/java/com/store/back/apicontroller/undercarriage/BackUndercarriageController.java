package com.store.back.apicontroller.undercarriage;
...
@RestController
@RequestMapping("/back/api/undercarriage")
public class BackUndercarriageController {
	 ...
	 * @return
	 */
	@RequiresPermissions("back:api:undercarriage:delete")
	@RequestMapping(value = "/delete", method = RequestMethod.POST)
	public JSONObject delete(String id) {
		log.info("/back/api/undercarriage/delete.json : \n");
		log.info("id = " + id + "\n");
		try {
	 ...
	 * @return
	 */
	@RequiresPermissions("back:api:undercarriage:batchRemove")
	@RequestMapping(value = "/batchRemove", method = RequestMethod.POST)
	public JSONObject batchRemove(@RequestParam("ids[]")String[] ids) {
		log.info("/back/api/undercarriage/batchRemove.json : \n");
		log.info("ids = " + ids + "\n");
		try {
	 ...
	 * @return
	 */
	@RequiresPermissions("back:api:undercarriage:update")
	@RequestMapping(value = "/update", method = RequestMethod.POST)
	public JSONObject update(Goods goods, HttpServletResponse resp) {
		log.info("/back/api/undercarriage/update.json : \n");
	...
	PageUtils list(@RequestParam Map<String, Object> params) {
		log.info("/back/api/undercarriage/page.json : \n");
